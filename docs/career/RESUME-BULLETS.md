# SentinelLab — Resume Bullets & Elevator Pitches
...
* **Engineered SentinelLab**, an offline SOC Tier 1 attack detection and incident response training platform utilizing Next.js 15, FastAPI, and SQLite to simulate end-to-end security operations workflows in a safe local environment.
